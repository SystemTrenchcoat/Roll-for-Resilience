...
status: WIP
chapterId: Middle
synopsis: An older sentient robot asks the party to help locate a cache left behind by its creator.
linkedCharacters:
  - "[[Donic]]"
  - "[[Ruby Marsh]]"
linkedGroups:
...
# Hook
___
*As the [[Loud House Tavern|Loud House]] sits emptied, [[Donic]] senses the party, fresh from [[The Burrow]], making their way towards the stairs and calls them over. He introduces himself and clears any tension, just an old bot lost in cherishing the past, he says. In fact, he could use the party's help finding goodies his creator left behind.*
# Story Beats
___
## 1. Hearing for help
...
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Donic's Hand | Sporting three metallic fingers on one side with a thumb stub on the other, this Chestnut masterwork is rather dexterous, as each individual finger can bend in directions past the standard of most creatures. You conclude Donic's hand simply must be the key, especially since you watched him remove it so willingly before. |


# Setting
___
## Key Locations
- [[Loud House Tavern]] / [[The Fluffy Queen Inn]]
- [[Nervios Tunnels]]
- [[Rebel Cache]]
## Hiding Spots
The segment of the tunnels has a couple dead ends to it where the players can hide if they need to. Alternatively, a player could easily navigate their way back to the surface if the tunnels themselves are too cramped for them. All they would need to do is let the party know where they'd wanna meet back up with everyone else. 

## Motivators
- Donic needs to return in time for his next performance
- Creatures lurking in the dim tunnels